...
public class Gerente {
    ...
    public void LoginGerente() throws ListaVaziaException, ValorRepetidoException {
        ...
        do {
            Menus.MenuGerente();
            System.out.println("Informe a opï¿½ï¿½oo: ");
    ...
    public void Contratar() throws ValorRepetidoException {
        ...
        System.out.println("O código de login do vendedor é " +codigo);
        codigo++;
    ...
    public void Demitir() throws ListaVaziaException {
        ...
        Vendedor Vef;
        do {
            System.out.println("Digite o CPF do funcionï¿½rio a ser demitido: ");
            cpf = input.nextLine();
            try {
        ...
        if (Vef.getSenha().equals(senha)) {
            ...
            System.out.print("FuncionÃ¡rio Demitido");
